        ...
        <div className="mobile-logo my-15">
          <Link href="/">
            <div className="relative">
              <img className="w-[120px] -z-10" src="assets/images/logos/logo.png" alt="Logo" title="Logo" />
              {/* <img
      ...
      <div className="container-fluid clearfix">
        <div className="header-inner d-flex align-items-center">
          ...
          <div className="menu-icons">
            {/* Nav Search */}
            <div className="nav-search py-15 mr-4">
              <SearchBtn />
            </div>
            ...
            <button className="user">
              <Link href={'/signin'} className="far fa-user-circle" />
            </button>
            <Link href="/contact">
      ...
      <div className="container-fluid clearfix">
        <div className="header-inner d-flex align-items-center">
          ...
          <div className="menu-icons">
            ...
            <Link href={'/cart'} className="cart px-4">
              <i className="far fa-shopping-basket" />
              <span>5</span>
            </Link>
            <button className="user">
